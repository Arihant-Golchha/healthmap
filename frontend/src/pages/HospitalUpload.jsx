...
import { UploadCloud, File, X, CheckCircle, BriefcaseMedical, XCircle, FileText, Trash2, Eye, User, ChevronDown, ChevronUp, Shield } from "lucide-react"
            ...
            <div className="flex-1 overflow-y-auto pt-14 lg:pt-0">
                ...
                <div className="max-w-2xl mx-auto px-4 py-10">
                    <div className="mb-8">
                        ...
                        <p className="text-slate-500 mt-1">Upload reports and manage doctor approvals.</p>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-slate-100">
                        <div className="bg-blue-600 px-8 py-10 text-center">
                            ...
                            <h2 className="text-3xl font-bold text-white mb-2">Upload Medical Report</h2>
                            <p className="text-blue-100">Securely upload medical reports to patient profiles using their Medical ID.</p>
                        </div>
                                ...
                                <form onSubmit={uploadReport} className="space-y-6">
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            type="text"
                                            required
                                            className="block w-full px-4 py-3 border border-slate-200 rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <select
                                            ...
                                            className="block w-full px-4 py-3 border border-slate-200 rounded-xl text-slate-800 bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                                        >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        {!file ? (
                                            <div className="relative border-2 border-dashed border-slate-300 rounded-xl p-8 text-center hover:bg-slate-50 hover:border-blue-400 transition-colors cursor-pointer group">
                                                <input
                                                    type="file"
                                                ...
                                                <div className="relative z-0 flex flex-col items-center justify-center pointer-events-none">
                                                    <UploadCloud className="h-10 w-10 text-slate-400 mb-3 group-hover:text-blue-500 transition-colors" />
                                                    <p className="text-slate-600 font-medium mb-1 group-hover:text-blue-600 transition-colors">Click to select a file</p>
                                            ...
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex flex-wrap items-center gap-3 mt-1">
                                                        <span className="text-xs font-mono font-medium text-blue-700 bg-blue-50 px-2 py-0.5 rounded">{patient.medicalId}</span>
                                                        <span className="text-xs font-medium text-slate-500 bg-slate-100 px-2 py-0.5 rounded capitalize">{patient.gender || "N/A"}</span>
                                                        <span className="text-xs font-medium text-emerald-700 bg-emerald-50 px-2 py-0.5 rounded">{patient.reports.length} report{patient.reports.length !== 1 ? 's' : ''}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <button className="flex items-center gap-1 text-sm font-medium text-blue-600 hover:text-blue-800 transition-colors px-3 py-2 rounded-lg hover:bg-blue-50">
                                                    ...
                                                    {patient.reports.map(report => (
                                                        <div key={report._id} className="bg-white rounded-xl border border-slate-200 p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 hover:shadow-sm transition-shadow">
                                                            ...
                                                            <div className="flex gap-2 shrink-0 w-full sm:w-auto">
                                                                <a href={report.fileUrl} target="_blank" rel="noreferrer" className="flex-1 sm:flex-none px-4 py-2 border border-slate-200 bg-white text-slate-700 hover:text-blue-700 hover:border-blue-300 rounded-lg text-sm font-medium transition-all text-center flex items-center justify-center gap-1">
                ...
                <section className="max-w-4xl mx-auto px-4 pb-12">
                    <div className="bg-white rounded-2xl shadow-lg border border-slate-100 overflow-hidden">
                        <div className="bg-blue-50 px-6 py-5 border-b border-blue-100">
                            ...
                            <p className="text-sm text-blue-700 mt-1">Review and approve doctor registration requests.</p>
                        </div>
                                ...
                                {pendingDoctors.map(doctor => (
                                    <div key={doctor._id} className="bg-slate-50 p-5 rounded-xl border border-slate-200 hover:shadow-md transition-shadow">
                                        ...
                                        <div className="bg-blue-50 p-3 rounded-lg mb-4">
                                            <p className="text-xs text-blue-800 font-semibold mb-1">Medical License Number</p>
                                            <p className="font-mono text-blue-900 text-sm break-all">{doctor.licenseNumber}</p>
                                        </div>
